 ...
 */
@SpringBootTest(classes = EMSTestConfiguration.class)
@ActiveProfiles("ems")
public class EMSConsumerIT {
    ...
    */
   @Test
   public void testSendJMSBytesMessage() {
      JMSTestUtils.executeSendMessage(MESSAGE_ITERATIONS, this.properties, (SpringBootCamelContext) this.context, true);
   }
}