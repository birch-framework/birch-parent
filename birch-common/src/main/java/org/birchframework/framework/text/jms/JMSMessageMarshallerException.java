...
/**
 * General exception for various {@link JMSMessageMarshaller} operations.
 * @author Keivan Khalichi
 */
public class JMSMessageMarshallerException extends BaseRuntimeException {

   public JMSMessageMarshallerException(final ErrorCode<?> theErrorCode) {
      super(theErrorCode);
   }

   public JMSMessageMarshallerException(final ErrorCode<?> theErrorCode, final Throwable theCause) {
